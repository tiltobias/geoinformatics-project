...
plt.plot(ex_kalman[:, 1], ex_kalman[:, 0], label='Extended Kalman Filter', color='blue', linewidth=2)
plt.scatter(ex_kalman[0, 1], ex_kalman[0, 0], color='green', label='Start Point', s=100)
