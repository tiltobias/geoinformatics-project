...
def calculate_kalman(LSM_coords: np.ndarray, sigma_obs=5., sigma_dm_pos=1., sigma_dm_vel=0.3) -> np.ndarray:
    """
    ...
    C_model = np.diag([sigma_dm_pos**2, sigma_dm_pos**2,
                   sigma_dm_vel**2, sigma_dm_vel**2])
